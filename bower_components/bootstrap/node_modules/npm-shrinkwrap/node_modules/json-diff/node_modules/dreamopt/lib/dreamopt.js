...
Option = (function() {
  function Option(_at_shortOpt, _at_longOpt, _at_desc, tagPairs, _at_metavars, _at_defaultValue) {
    var $, tag, value, _i, _len, _ref;
    this.shortOpt = _at_shortOpt;
    this.longOpt = _at_longOpt;
    this.desc = _at_desc;
    this.metavars = _at_metavars;
    this.defaultValue = _at_defaultValue;
...
Command = (function() {
  function Command(_at_name, _at_desc, _at_syntax) {
    this.name = _at_name;
    this.desc = _at_desc;
    this.syntax = _at_syntax;
    this.func = null;
  }
...
Syntax = (function() {
  function Syntax(_at_handlers, specs) {
    this.handlers = _at_handlers;
    if (specs == null) {
      specs = [];
    }
    this.usage = [];
  ...
  Syntax.prototype.parse = function(argv) {
    ...
    processOption = (function(_this) {
      return function(result, arg, option, value) {
    ...
    assignValue = (function(_this) {
      return function(result, option, value) {
        if (option.tags.list) {
...
//# sourceMappingURL=dreamopt.js.map
